...
INSERT INTO `Student` VALUES (1,'kaan','mersin',60,2015,1),(2,'meric','celik',60,2016,2),(3,'okan','alan',100,2015,1),(4,'emre','kocan',10,2018,2),(5,'batuhan','mete',78,2017,5),(6,'bilge','cimen',45,2014,4),(7,'oguz','bakir',45,2016,3),(8,'baran','burasli',55,2015,1),(9,'onur fatih','demir',75,2017,6),(10,'akif','baysal',34,2018,5),(11,'tarik','isildar',38,2017,6);
...
IF (YEAR(CURDATE())-new.startYear)>=4
	THEN SET new.creditLimit = 48;
	ELSEIF (YEAR(CURDATE())-new.startYear)=3
	THEN SET new.creditLimit = 42;
	ELSEIF (YEAR(CURDATE())-new.startYear)=2
	THEN SET new.creditLimit = 38;
	ELSE
	SET new.creditLimit = 30;
END IF;
...
-- Dump completed on 2019-12-21 13:31:21
